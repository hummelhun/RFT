...
public class Core {
	...
	public void startGame() {
		...
		player1 = new Player(0, "Uther", hand1, deck1, board1, 2, 2, 30, "Uther_Lightbringer3.png");
		for (int i = 0; i < 3; i++) {		
	  	  player1.getHand().add(player1.getDeck().get(0));
		  player1.getDeck().remove(0);
		}
		player2 = new Player(1, "Jaina", hand2, deck2, board2, 2, 2, 30, "Jaina_Proudmoore3.png");
		for (int i = 0; i < 3; i++) {		
