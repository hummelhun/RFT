...
public class Core {
	...
	public void startGame() {
		...
		player1 = new Player("Bloody Steve", hand1, deck1, 1, 1, 20);
		for (int i = 0; i < 3; i++) {		
	  	  player1.getHand().add(player1.getDeck().get(0));
		  player1.getDeck().remove(0);
		}
		player2 = new Player("Noob Bob", hand2, deck2, 0, 0, 25);
		for (int i = 0; i < 3; i++) {		
...
//			System.out.println(player1.getDeck().get(i).getCardName());
//		}
//		System.out.println("--------------");
//		for (int i = 0; i < player1.getHand().size(); i++) {
//			System.out.println(player1.getHand().get(i).getCardName());
//		}
